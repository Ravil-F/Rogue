...
Игрок управляет перемещением персонажа и может взаимодействовать с предметами или сражаться с противниками.\
...
Еда, эликсиры, свитки при использовании тратятся. Оружие при смене падает на пол на соседнюю клетку.
...
При использовании предмета игра показывает список, в котором нужно выбрать конкретный предмет
