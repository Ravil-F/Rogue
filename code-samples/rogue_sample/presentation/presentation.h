...
void create_new_map(map_t* map, const level_t* level, const player_t* player,
                    const battle_info_t* battles);
void display_map(map_t* map, const level_t* level, const player_t* player,
                 const battle_info_t* battles);
