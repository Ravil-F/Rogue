 ...
 *
 * Для хранения используются файлы .json, их обработка происходит при помощи
 * библиотеки json-c
 ...
 */
void load_data(player_t* player, level_t* level, map_t* map,
               battle_info_t* battles, const char* save_path,
 ...
 */
void save_data(const player_t* player, const level_t* level, const map_t* map,
               const char* filename);
 ...
 */
void init_level(player_t* player, level_t* level, map_t* map,
                battle_info_t* battles, const char* stat_path);
